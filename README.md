...
*  **[Full Case Study Report](./examples.md)**: Click here to view the interpretive summary connecting computational results with codicological observations.
*  **[Core Analysis Script](./script.md)**: Click here to view the Python engine used for this research.
